...
public class WaveLineView extends RenderView {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        thickLineWidth = (int) t.getDimension(R.styleable.WaveLineView_wlvThickLineWidth, UIUtils.dip2Px(2));
        fineLineWidth = (int) t.getDimension(R.styleable.WaveLineView_wlvFineLineWidth, UIUtils.dip2Px(1.5));
    ...
    private void initDraw(Canvas canvas) {
        ...
        LinearGradient linearGradient = new LinearGradient(0, 0, getMeasuredWidth(), 0,
                new int[]{UIUtils.getColor(R.color.colorFF9100), UIUtils.getColor(R.color.colorFFD400)},
                null,
