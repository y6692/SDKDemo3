...
import com.centaurstech.qiwu.utils.ChineseCalendar;
...
public class GregorianLunarCalendarView extends LinearLayout implements NumberPickerView.OnValueChangeListener{
    ...
    private static final int YEAR_STOP = 2200;
    ...
    private void initInternal(Context context){
        View contentView = inflate(context, R.layout.layout_gregorian_lunar_calendar, this);
        ...
        if(isGregorian){
            if(mDisplayYearsGregorian == null){
                ...
                for(int i = 0; i < YEAR_SPAN; i++){
                    mDisplayYearsGregorian[i] = String.valueOf(YEAR_START + i) + year;
                }
            }
            if(mDisplayMonthsGregorian == null){
                ...
                for(int i = 0; i < MONTH_SPAN_GREGORIAN; i++){
                    mDisplayMonthsGregorian[i] = String.valueOf(MONTH_START_GREGORIAN + i) + month;
                }
            }
            if(mDisplayDaysGregorian == null){
                mDisplayDaysGregorian = new String[DAY_SPAN_GREGORIAN];
                for(int i = 0; i < DAY_SPAN_GREGORIAN; i++){
                    mDisplayDaysGregorian[i] = String.valueOf(DAY_START_GREGORIAN + i) + day;
                }
            }
        }else{
